...
import { registerUser } from "../modules/fetch/user";
...
function RegisterForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      if (!e.target.username.value || !e.target.email.value || !password) {
    ...
    return (
        ...
        <div className="h-[95vh] bg-gray-100 text-gray-900 flex justify-center mt-10">
            ...
            <div className="mt-12 flex flex-col items-center">
                <div className="w-full flex-1 mt-8">
                    ...
                    <div className="mx-auto max-w-xs">
                        ...
                        <input
                            className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                            type="password" name="password" placeholder="Password" value={confirmPassword}
    ...
    {successMessage === "Registration successful!" && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              <div className="bg-white p-8 rounded-lg z-10 h-48 w-96 ">
                ...
                <button
                  ...
                  className="bg-blue-500 text-white w-full py-2 rounded hover:bg-blue-700 mt-10"
                >
                  Sign In
                </button>
              </div>
